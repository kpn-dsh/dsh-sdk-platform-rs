...
pub async fn appcatalog_tenant_appcatalogapp_appcatalogappid_configuration_get(configuration: &configuration::Configuration, tenant: &str, appcatalogappid: &str) -> Result<models::AppCatalogAppConfiguration, Error<AppcatalogTenantAppcatalogappAppcatalogappidConfigurationGetError>> {
    let local_var_configuration = configuration;
...
pub async fn appcatalog_tenant_appcatalogapp_appcatalogappid_configuration_put(configuration: &configuration::Configuration, tenant: &str, appcatalogappid: &str, app_catalog_app_configuration: models::AppCatalogAppConfiguration) -> Result<(), Error<AppcatalogTenantAppcatalogappAppcatalogappidConfigurationPutError>> {
    let local_var_configuration = configuration;
...
pub async fn appcatalog_tenant_appcatalogapp_appcatalogappid_status_get(configuration: &configuration::Configuration, tenant: &str, appcatalogappid: &str) -> Result<models::AllocationStatus, Error<AppcatalogTenantAppcatalogappAppcatalogappidStatusGetError>> {
    let local_var_configuration = configuration;
