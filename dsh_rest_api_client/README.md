...
#### DSH Rest API Client: 0.8.0
- OpenAPI spec: 1.13.0
- Progenitor version: 0.10.0
- Reqwest client 0.13
- Feature flags "types" and "client"

#### DSH Rest API Client: 0.7.0
- OpenAPI spec: 1.12.0
- Progenitor version: 0.10.0
- Reqwest client 0.13
- Feature flags "types" and "client"

#### DSH Rest API Client: 0.6.0
- OpenAPI spec: 1.11.1
- Progenitor version: 0.10.0
- Reqwest client 0.13
- Feature flags "types" and "client"
...
```toml
[dependencies]
dsh_rest_api_client = "0.7"
dsh_sdk = { version = "0.8", features = ["management-api-token-fetcher"], default-features = false }
