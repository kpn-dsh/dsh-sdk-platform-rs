# Rust API client for dsh-openapi-rest-client
...
Put the package under your project folder in a directory named `dsh-openapi-rest-client` and add the following to `Cargo.toml` under `[dependencies]`:

```
dsh-openapi-rest-client = { path = "./dsh-openapi-rest-client" }
```
