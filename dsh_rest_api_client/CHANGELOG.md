...
## [0.8.0] - 2026-05-13
### Changed
- TaskState started_at is now optional, as this is Null when state is Starting/Staging


## [0.7.0] - 2026-05-13
### Changed
- TaskState enum values now includes missing items
...
### Changed
- updated crate to OpenAPI spec: 1.11.1
- **Breaking change:**: Bump Reqwest to 0.13
- Progenitor version: 0.12.0
